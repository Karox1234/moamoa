...
@Component
@Service
class RedissonLockManagerImpl(private val redissonClient: RedissonClient):RedissonLockManager {
    private val log = LoggerFactory.getLogger(RedissonLockManagerImpl::class.java)
